...
def annotate_image(img_in,frame_name):
	"""
	...
	result = final_viz(undist, left_fit, right_fit, m_inv, left_curve, right_curve, vehicle_offset,frame_name)
...
if __name__ == '__main__':
	# Annotate the video
	annotate_video('carla_road(24fps)NEW_JL.avi', 'out_carla2.mp4')
